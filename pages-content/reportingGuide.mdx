...
In that case, you can make a report directly to the Conference Chair, Kalyan Prasad. He can be reached at the mobile no. +91-9032297710 and the email address [kalyanprsd@gmail.com](mailto:kalyanprsd@gmail.com). The chair will follow the usual enforcement process with the other members, but will exclude the member(s) that the report concerns, from any discussion or decision making.
