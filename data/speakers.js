...
export const SPEAKERS = [
  ...
  {
    name: 'Gokulavasan Murali',
    slug: 'gokulavasan-murali',
    type: 'Session',
    activeSpeakerPage: true,
    title: 'Head of Engineering at Emma Robot',
    bio: 'Gokul is Head of Engineering at Emma Robots, building vision-first AI systems where autonomous agents perceive and operate software like humans. His work focuses on Computer Vision, agentic systems, and the future of autonomous digital workers.',
    imgUrl: '/images/speakers/gokulavasan-murali.jpg',
    imgAlt: 'Picture of Gokulavasan Murali.',
    socials: [
      {
        name: 'LinkedIn',
        url: 'https://www.linkedin.com/in/gok03/',
        ariaLabel: "Hyperlink to Gokulavasan Murali's LinkedIn page.",
      },
      {
        name: 'Globe',
        url: 'http://gok03.com',
        ariaLabel: "Hyperlink to Gokulavasan Murali's website.",
      },
    ],
  },
  {
